...
void renderAxisFrame()
{
	...
	//Draw the x grid lines, scaled for zooming
	glBegin(GL_LINES);
	...
	//Draw the y grid lines, scaled for zooming
	glBegin(GL_LINES);
	for(int i=0;i<=gFrameSpacing;i++) 
	{
		glColor4f(0.8,0.8,0.8,0.5);
	...
	//Draw the z grid lines, scaled for zooming
	glBegin(GL_LINES);
	for(int i=0;i<=gFrameSpacing;i++) 
	{
		glColor4f(0.8,0.8,0.8,0.5);
...
void renderPoints()
{
	...
	for(float i =-gXRes/2.0f; i<gXRes/2.0f; i++)
	{
		for(float j=-gXRes/2.0f; j<gXRes/2.0f; j++)
		{
